...
const validationSchema = Yup.object().shape({
  ...
  phone: Yup.string().matches(/^\d{10}$/, 'Phone number must be 10 digits').required('Phone is required'),  idType: Yup.string().required('ID type is required'),
        ...
        {({ errors, touched, setFieldTouched, values, isValid }) => {
          ...
          return (
            <Form>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700">Choose a Category</label>
                <Field
                  as="select"
                  name="category"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
              ...
              <div className="mb-4">
  <label className="block text-sm font-medium text-gray-700">Select Id</label>
  <Field
    as="select"
    name="idType"
    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
    ...
    <ErrorMessage name="idType" component="div" className="text-red-500 text-sm mt-1" />
              ...
              <div className="mb-4">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-600">I acknowledge I am a sole proprietor.</span>
                </label>
              </div>
              ...
              <div className="mb-4">
                <label className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600">
                    I agree to TaskRabbit's <a href="#" className="text-indigo-600">Terms of Service</a> and <a href="#" className="text-indigo-600">Privacy Policy</a>.
                  </span>
                </label>
